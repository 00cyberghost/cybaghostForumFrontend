...
<template>
    <div class="fixed top-[40vh] w-[95vw] md:w-[45vw]">
        <form :action="`${useRuntimeConfig().public.baseURL}/images/upload`" method="post" class="dropzone hidden relative mx-auto bg-primary my-4 dark:text-white" id="dropzone">
